...
class ViagemModel(Base):
    ...
    id_viagem: Mapped[int] = mapped_column(BigInteger, primary_key=True, index=True, autoincrement=True)
    id_avaliacao: Mapped[Optional[int]] = mapped_column(BigInteger, ForeignKey('avaliacao.id_avaliacao', ondelete="CASCADE"), unique=True, nullable=False)
