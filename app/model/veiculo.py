...
class VeiculoModel (Base):
    ...
    id_modelo: Mapped[int] = mapped_column(Integer, ForeignKey('modelo.id_modelo', ondelete="CASCADE"), nullable=False)
    id_classe: Mapped[int] = mapped_column(Integer, ForeignKey('classe.id_classe', ondelete="CASCADE"), nullable=False)
