...
class PagamentoModel(Base):
    ...
    id_corrida: Mapped[int] = mapped_column(BigInteger, ForeignKey('corrida.id_corrida', ondelete="CASCADE"), unique=True)
    id_metodo_pagamento: Mapped[int] = mapped_column(SmallInteger, ForeignKey('metodo_pagamento.id_metodo_pagamento', ondelete="CASCADE"), unique=True)
